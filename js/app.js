...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h4>${product.title}</h4>
      <h6>Average-rating:  <i class="fas fa-star text-warning"></i>  <span class="review">${product.rating.rate}</span></h6>
      <h6>Total feedback: <i class="fas fa-user text-success"></i> <span class="review">${product.rating.count}</span></h6>
